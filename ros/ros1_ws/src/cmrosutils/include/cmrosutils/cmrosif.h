...
#ifndef CM_ROS_UTILS_CMROSIF_H
#define CM_ROS_UTILS_CMROSIF_H
...
#include "cmrosutils/CMRemoteControl.h"
#include "cmrosutils/cmjob_publisher.h"
#include "cmrosutils/cmjob_subscriber.h"
