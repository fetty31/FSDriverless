...
static const char *CompileFlags[] = {
    ...
    "-DWITH_CMCPPIF",
    "-I/opt/ipg/carmaker/linux64-11.0.1/include",
...
tAppStartInfo   AppStartInfo = {
    "Car_Generic 11.0.1 with CMRosIF",          /* App_Version         */
    "13",          /* App_BuildVersion    */
    "fetty",     /* App_CompileUser     */
    "fetty",         /* App_CompileSystem   */
    "2023-03-30 13:18:51",  /* App_CompileTime */
